...
public class cal_userxcamera extends AppCompatActivity {
    TextView txtResult;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cal_userxcamera);
        ...
        btncamerapro.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!lastmeterxcm1.isEmpty()&& !unitcame2.isEmpty()&& !moneycame3 .isEmpty()){
                    Intent intent = new Intent(cal_userxcamera.this,calmainxuser.class);
